...
public class AlbumController {
    ...
    public String SignUp(@RequestParam(value="username")String username,@RequestParam(value="password") String password,
                         @RequestParam(value="status") String status,@RequestParam(value="email") String email,
                         @RequestParam(value="phone") String phone){
        System.out.println(username+" : "+password+" : "+status+":"+email+":"+phone);
        return "Successfully";
    }
    @PostMapping(path = "postAd",produces = "application/json")
    public String CreateAd(@RequestParam(value = "itemName") String itemName , @RequestParam(value = "price") String price,
                              @RequestParam(value = "stock") String stock, @RequestParam(value = "description",required = false) String des,
                              @RequestParam(value = "image", required = false) MultipartFile image) throws IOException {

        if(image != null)
        System.out.println(image.getContentType()+" "+image.getBytes().length);
        System.out.println(itemName+":"+price+":"+stock+":"+des+":"+image.getBytes().length);
